...
def extrair_dados(driver):     
    ...
    # Criar uma pasta para salvar os arquivos HTML, se não existir
    ...
    original_window = driver.current_window_handle 
        ...
        # Salvar o arquivo HTML na pasta criada
    for index, (link, name) in enumerate(zip(links, files_name)):
        driver.switch_to.new_window('tab')
        driver.get(link)    
    
        with open(os.path.join(pasta_html, f'documento_{name}.html'), 'w', encoding='utf-8', errors='ignore') as file:
